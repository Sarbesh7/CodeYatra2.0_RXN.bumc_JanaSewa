...
export const translations = {
  en: {
    ...
    templates: "Templates",
    templatesDesc: "Get access to application form templates, guidelines, and document checklists for various services.",
    downloadTemplates: "Download Templates",
    nearestOffice: "Nearest Office",
    profile: "Profile",
    requiredDocuments: "Required Documents",
    bringDocuments: "Please bring these documents when you visit",
    documentsCount: "Documents",
    importantNote: "Important:",
    documentsWarning: "All documents must be original or certified copies. Incomplete documents may delay your application.",
    required: "Required",
    keepDocumentsReady: "Keep all original documents ready for verification",
    ...
    yourSerialNumber: "Your Serial Number:",
    saveSerialNumber: "Save this number to track your application",
  ...
  np: {
    ...
    templates: "सिफारिस",
    templatesDesc: "विभिन्न सेवाहरूको लागि आवेदन फारम, दिशानिर्देशहरू, र कागजात चेकलिस्टहरू प्राप्त गर्नुहोस्।",
    downloadTemplates: "सिफारिस डाउनलोड गर्नुहोस्",
    nearestOffice: "नजिकको कार्यालय",
    profile: "प्रोफाइल",
    requiredDocuments: "आवश्यक कागजातहरू",
    bringDocuments: "कृपया भ्रमण गर्दा यी कागजातहरू ल्याउनुहोस्",
    documentsCount: "कागजातहरू",
    importantNote: "महत्त्वपूर्ण:",
    documentsWarning: "सबै कागजातहरू मूल वा प्रमाणित प्रतिलिपिहरू हुनुपर्छ। अपूर्ण कागजातहरूले तपाईंको आवेदनमा ढिलाइ गर्न सक्छ।",
    required: "आवश्यक",
    keepDocumentsReady: "प्रमाणीकरणको लागि सबै मूल कागजातहरू तयार राख्नुहोस्",
    ...
    wardNo: "वडा नं.",
    address: "ठेगाना",
    additionalRemarks: "थप टिप्पणीहरू",
    submitApplication: "आवेदन पेश गर्नुहोस्",
    applicationSubmitted: "आवेदन पेश भयो!",
    applicationSuccess: "तपाईंको आवेदन सफलतापूर्वक पेश गरिएको छ।",
    yourSerialNumber: "तपाईंको क्रम संख्या:",
    saveSerialNumber: "तपाईंको आवेदन ट्र्याक गर्न यो नम्बर सुरक्षित राख्नुहोस्",
